...
public class AAgent : Agent {
	...
	public override void AgentAction(float[] vectorAction, string textAction)
	{
		...
		float scoreDistance = Vector2.Distance(goalB.position, Ball.position);
		float defendDistance = Vector2.Distance(goalA.position, Ball.position);
		// Time penalty
